...
game.EnemyEntity = me.Entity.extend({
    ...
    init:function (x, y, settings) {
        // salvam lungimea elementului din harta
        // (locul unde se plumba)
        var width = settings.framewidth || settings.width

        // definim imaginea
        settings.image = "wheelie_right.png"
        ...
        // setam tipul de coliziune pentru a recunoste acest tip de obiect
    ...
    update : function (dt) {
        ...
        if (this.walkLeft && this.pos.x <= this.startX) {
            ...
            // il intoarce cu fata spre dreapta
       ...
       this.body.update(dt)
         ...
         // verificam daca corpul se misca
