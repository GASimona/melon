...
game.PlayerEntity = me.Entity.extend({
    ...
    init:function (x, y, settings) {
        ...
        // setam viteza maxima si fictiunea
        ...
        // setam numarul initial de sarituri
        this.multipleJump = 1
    ...
    update : function (dt) {
        ...
        if (me.input.isKeyPressed("jump")) {
            ...
            // setam viteza 0 pe axa y
            this.body.force.y = 0
            // cand coorpul nu se misca
            if (!this.body.jumping && !this.body.falling) {
                //resetam multiple jump
                this.multipleJump = 1
            }
            // daca este in cadere setam multiple jump la 2
